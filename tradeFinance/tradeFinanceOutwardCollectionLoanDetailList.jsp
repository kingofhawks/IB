...
<html:form action="tradeFinanceEbManageAction.do">
		...
		<table width="100%" height="100%" border="0" align="center"
			...
			<tr>
				...
				<div id="innerTable_divLis" style="width:96%"><!-内容开始--><%String cost = com.witsoft.common.Constant.isHaveReceiveDraft(prid,(String)request.getAttribute("tabID"));%><script>showDone("<%if(request.getAttribute("msg")!=null){out.print(request.getAttribute("msg"));}%>");</script> <logic:equal
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						id="item_list">
						<tr>
							<th width="38%"><bean:message key="common.ibno" /><!--进口来单号--></th>
							<th width="27%"><bean:message key="common.clno" /><!--客户号--></th>
							...
							<logic:iterate id="list" name="list" indexId="index" scope="request">
								<span
									<%=cost%>="openReplace('<%=prid%>.do?rfno=<bean:write
                                        name="list" property="id.ibno" />&prid=<%=prid%>')">
            ...
            out.print("<tr bgcolor=\"#ECF4FC\" onmouseover=\"this.style.backgroundColor=\'#FFCC99\';\" onmouseout=\"this.style.backgroundColor=\'#ECF4FC\';\">");
             ...
             out.print("<tr bgcolor=\"#ffffff\" onmouseover=\"this.style.backgroundColor=\'#FFCC99\';\" onmouseout=\"this.style.backgroundColor=\'#ffffff\';\">");
									...
									<td><bean:write name="list" property="id.ibno" /></td>
						...
						<logic:notEqual name="userCommonForm" property="tabID" value="1">
						<logic:notEqual name="userCommonForm" property="tabID" value="0">
                         <table width="100%" border="0" cellpadding="0" cellspacing="1"
						id="item_list">
						<tr>
							<th width="16%"><bean:message key="common.bpno" /><!--议付号--></th>
							<th width="18%"><bean:message key="common.rfno" /><!--交易流水--></th>
							<th width="16%"><bean:message key="common.evno" /><!--借据号--></th>
							<th width="17%"><bean:message key="common.clno" /><!--客户号--></th>
							<th width="16%">银行编号<!--机构号--></th>
							<th width="17%"><bean:message key="common.dldt" /><!--处理日期--></th>
						</tr>
						<logic:notEmpty name="list">
							<logic:iterate id="list" name="list" indexId="index" scope="request">
								<%if ((index.intValue() % 2) == 1) {
            out.print("<tr bgcolor=\"#ECF4FC\" onmouseover=\"this.style.backgroundColor=\'#FFCC99\';\" onmouseout=\"this.style.backgroundColor=\'#ECF4FC\';\">");
             ...
             out.print("<tr bgcolor=\"#ffffff\" onmouseover=\"this.style.backgroundColor=\'#FFCC99\';\" onmouseout=\"this.style.backgroundColor=\'#ffffff\';\">");
									...
									<td><bean:write name="list" property="evno" /></td>
									<td><bean:write name="list" property="clno" /></td>
									<td><bean:write name="list" property="id.brno" /></td>
				...
				<logic:equal name="userCommonForm"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						id="item_list">
						<tr>
							<th width="14%"><bean:message key="common.mgtp" /></th>
							<th width="25%"><bean:message key="common.sentBrno" /></th>
							<th width="30%"><bean:message key="common.prid" /></th>
							<th width="20%">业务编号</th>
