...
<html:form action="tradeFinanceIbManageAction.do">
			...
			<tr>
				...
				<div id="innerTable_divLis" style="width:96%"><!-内容开始--><%String cost = com.witsoft.common.Constant.isHaveReceiveDraft(prid,(String)request.getAttribute("tabID"));%><script>showDone("<%if(request.getAttribute("msg")!=null){out.print(request.getAttribute("msg"));}%>");</script> <logic:equal
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						id="item_list">
						<tr>
							<th width="30%"><bean:message key="common.ibno" /><!--进口来单号--></th>
...
<logic:notEqual name="userCommonForm"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						id="item_list">
						<tr>
							<th width="17%"><bean:message key="common.ibno" /><!--进口来单号--></th>
							<th width="16%"><bean:message key="common.rfno" /><!--交易流水--></th>
							<th width="12%"><bean:message key="common.evno" /><!--借据号--></th>
							<th width="15%"><bean:message key="common.lcno" /><!--信用证号--></th>
							<th width="12%"><bean:message key="common.clno" /><!--客户号--></th>
							<th width="15%">银行编号<!--机构号--></th>
							<th width="15%"><bean:message key="common.dldt" /><!--处理日期--></th>
						</tr>
						<logic:notEmpty name="list">
							<logic:iterate id="list" name="list" indexId="index" scope="request">
								<span
