...
<table width="100%" height="100%" border="0" align="center"
	...
	<tr>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<table width="375" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td height="20" align="right" valign="top">打包币种：</td>
								...
								<tr>
									<td height="20" align="right" valign="top" class="attR">*打包放款编号：</td>
									<td valign="top"><html:text title="neno" property="neno" maxlength="20"/></td>
								</tr>
								<tr>
								...
								<tr>
									<td height="20" align="right" valign="top" class="attR">*打包金额：</td>
									<td valign="top"><html:text title="gvvl" property="gvvl" maxlength="20" onkeypress="regInput(/^\d{1,}\.?\d{0,2}$/)" style="ime-mode:Disabled"/></td>
								</tr>
								<tr>
		...
		onClick="window.open('/IB/flowchart.do?id=<bean:write name="tradeFinancePackMakeLoansDetailForm" property="evno"/>&prid=<bean:write name="tradeFinancePackMakeLoansDetailForm" property="prid"/>','newwindow','toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no');return false">&nbsp;&nbsp;
		<%}
          }
		...
		onClick="openReplace('tradeFinanceEbManageAction.do?tabID=<%=tabID%>&prid=<bean:write name="tradeFinancePackMakeLoansDetailForm" property="prid"/>');return false">
