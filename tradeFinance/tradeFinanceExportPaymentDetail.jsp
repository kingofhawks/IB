...
<table width="100%" height="100%" border="0" align="center"
	...
	<tr>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<table width="375" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td height="20" align="right" valign="top">是否为额度贷款：</td>
									<td valign="top">
								...
								<tr>
									...
									<td valign="top"><html:text title="gvvl" property="gvvl"  onkeypress="regInput(/^\d{1,}\.?\d{0,2}$/)" style="ime-mode:Disabled"/></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">打包金额：</td>
									<td valign="top"><html:text property="dmamt"  readonly="true" onkeypress="regInput(/^\d{1,}\.?\d{0,2}$/)" style="ime-mode:Disabled"/></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">打包利率：</td>
									<td valign="top"><html:text property="dbrt"  readonly="true"/></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">打包天数：</td>
									<td valign="top"><html:text property="dbts"  readonly="true"/></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">融资(贷款入帐)帐号：</td>
									<td valign="top"><html:text property="leac" maxlength="36"/></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">入客户帐金额：</td>
		...
		onClick="window.open('/IB/flowchart.do?id=<bean:write name="tradeFinanceExportPaymentDetailForm" property="evno"/>&prid=<bean:write name="tradeFinanceExportPaymentDetailForm" property="prid"/>','newwindow','toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no');return false">&nbsp;&nbsp;
		<%}
          }
		...
		onClick="openReplace('tradeFinanceEbManageAction.do?tabID=<%=tabID%>&prid=<bean:write name="tradeFinanceExportPaymentDetailForm" property="prid"/>');return false">
