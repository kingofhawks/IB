...
<table width="100%" height="100%" border="0" align="center"
	...
	<tr>
		...
		<table width="100%" height="100%" border="0" align="center"
			...
			<tr>
				...
				<div id="innerTable_div" class="kuangScroll"><!--内容开始--> <html:form
					action="FHYH.do" onsubmit="checkForm(this)"
					method="post">
						...
						<tr>
							...
							<table width="375" border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td valign="top"><html:text property="clno" readonly="true"/>
									<html:image src="/IB/images/winsearch.gif" tabindex="1" property="more_btn" onclick="openWin('coin','clno');return false"></html:image></td>
								</tr>
								<tr>
								...
								<tr>
									<td height="20" align="right" valign="top">业务号码：</td>
								...
								<tr>
									...
									<td valign="top"><html:text  property="vldt"  readonly="true"/>
									<html:image src="/IB/images/date.gif" tabindex="1" property="more_btn" onclick="openWin('coin','vldt');return false"></html:image></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top" class="attR">*到期日：</td>
									<td valign="top"><html:text  title="madt"
										property="madt" readonly="true" /> <html:image src="/IB/images/date.gif" tabindex="1" property="more_btn" onclick="openWin('coin','madt');return false"></html:image></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">执行利率：</td>
									<td valign="top"><html:text property="inrt" maxlength="12"/></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td valign="top"><html:text title="dbam" property="dbam" onkeypress="regInput(/^\d{1,}\.?\d{0,2}$/)" style="ime-mode:Disabled" maxlength="15"/></td>
								</tr>
								<tr>
								...
								<tr>
									<td height="20" align="right" valign="top" class="attR">*返还融资帐号：</td>
									<td valign="top"><html:text title="leac" property="leac" maxlength="36" /></td>
								</tr>
								<tr>
			...
			<tr>
				...
				<td class="innerTable_bottom_x"> <html:hidden property="errCode" /> <html:hidden
		...
		onClick="window.open('/IB/flowchart.do?id=<bean:write name="tradeFinanceReturnDetailForm" property="evno"/>&prid=<bean:write name="tradeFinanceReturnDetailForm" property="prid"/>','newwindow','toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no');return false">&nbsp;&nbsp;
		<%}
          }
		...
		onClick="openReplace('tradeFinanceEbManageAction.do?tabID=<%=tabID%>&prid=<bean:write name="tradeFinanceReturnDetailForm" property="prid"/>');return false">
