     ...
     <tr>
	  ...
	  <tr>
        ...
        <td width="89%" align="left" valign="top">
            <label for="detai">
                <input type="text" class="form-control"  id="detai" name="detai" size="125" required="required" autofocus="autofocus"/>
            </label>
        </td>
      </tr>
      <tr>
        ...
        <td align="left" valign="top">
            <label for="grade">
                <input type="number" class="form-control"  id="grade" name="grade" size="125"/>
            </label>
        </td>
      </tr>
      <tr>
...
<%--                                <span class="selectBlueMS"><html:select styleClass="selectListBlueMS" title="ccrt_chco" property="ccrt_chco" >--%>
		...
		<table width="98%" id="">
            ...
            <button class="btn btn-primary" onclick="checkType('CDH','CD');return false" type="submit">
