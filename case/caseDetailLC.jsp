...
<table width="98%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="3%" align="center" valign="top">
        <input type="checkbox" name="lcopCheckbox" id="LC0" value="lcop" onClick="cheinner(this.checked,'lcop','0')" <%if(map!=null&&map.get("lcopCheckbox")!=null&&!((String)map.get("lcopCheckbox")).equals("")) out.print("checked");%>>
    </td>
    <td align="left" valign="top">
...
<tr>
    ...
    <td align="center"><input type="hidden" name="LCH" id="LCH" value="">
        ...
        <button class="btn btn-primary" onclick="checkType('0');return false" type="submit">
