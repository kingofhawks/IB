			...
			<tr>
				...
				<table width="100%" height="40" border="0" cellpadding="0"
					...
					<tr>
						...
						<!--SWIFT编号-->
						<th width="15%"><bean:message
							key="systemManage.systemTableManage.accountBank.INAC" /></th>
						<!--内部帐号-->
						<th width="60%"><bean:message
					...
					<logic:notEmpty name="list">
						<logic:iterate id="list" name="list" indexId="index" scope="request"> 
								...
								<td><bean:write name="list" property="cnco" /></td>
								<td><bean:write name="list" property="swno" /></td>
								<td><bean:write name="list" property="inac" /></td>
