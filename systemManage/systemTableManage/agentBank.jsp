				...
				<table width="100%" height="40" border="0" cellpadding="0"
					...
					<tr>
						...
						<th width="15%"><bean:message
							key="systemManage.systemTableManage.agentBank.SEXG" /></th>
						<!--交换日期-->
						<th width="15%"><bean:message
							key="systemManage.systemTableManage.agentBank.SEFT" /></th>
						<!--生效日期-->
						<th width="47%"><bean:message
							key="systemManage.systemTableManage.agentBank.SVLD" /></th>
						<!--有效截至日期-->
					</tr>
					<logic:notEmpty name="list">
						<logic:iterate id="list" name="list" indexId="index" scope="request"> 
								...
								<span
									onclick="openReplace('*?swno=<bean:write name="list" property="swno" />')">
								<td><bean:write name="list" property="swno" /></td>
								<td><bean:write name="list" property="sexg" /></td>
								<td><bean:write name="list" property="seft" /></td>
								<td><bean:write name="list" property="svld" /></td>
								</span>
							</tr>
						</logic:iterate>
					</logic:notEmpty>
