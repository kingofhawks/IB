...
<FIELDSET align=left>
<LEGEND align=left>输入表格参数</LEGEND>
      <table>
        <tr> 
          <td>线条颜色: 
            <select id=a>
              <option value="#999999"  selected>默认颜色</option>
            ...
            线条粗度: 
            <input  id=b ONKEYPRESS="event.returnValue=IsDigit();" value="2" size="4" maxlength=3></td>
        </tr>
        <tr> 
          <td> 页面对齐: 
            <select  id=d>
        ...
        <tr> 
          <td> 水平宽度: 
            <input id=e ONKEYPRESS="event.returnValue=IsDigit();" value="400" size="10" maxlength=3> 
            <br></td>
        </tr>
      </table>
