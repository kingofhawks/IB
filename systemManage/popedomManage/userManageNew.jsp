    ...
    <div class="container">
        <form class="form-horizontal" role="form" action="/IB/userManageNew.do" onsubmit="checkForm(this)" method="post">
            <div class="form-group">
                <label for="sType" class="col-sm-2 control-label">单个开户</label>
                <input type="radio" name="type" id="sType" value="single" checked onclick="switchNewUserType(1)"/>
                <label for="bType">批量开户</label>
                <input type="radio" name="type" id="bType" value="batch"  onclick="switchNewUserType(2)"/>
            </div>
            <div class="form-group">
