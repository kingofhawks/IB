...
task("minify-core", [], function (params) {
	...
	var settings = {
		...
		outputMinified: "js/tinymce/tinymce-4.0.26.min.js",
	...
	if (coverage) {
		...
		settings.outputCoverage = "js/tinymce/tinymce-4.0.26.min.js";
...
task("minify-jquery-plugin", [], function () {
	uglify({from: "js/tinymce/classes/jquery.tinymce.js", to: "js/tinymce/jquery.tinymce-4.0.26.min.js"});
});
...
task("bundle", ["minify"], function(params) {
	...
	minContent = fs.readFileSync("js/tinymce/tinymce-4.0.26.min.js").toString();
...
task("zip-production", ["mktmp"], function () {
	...
	zip({
		...
		exclude: [
			...
			"js/tinymce/jquery.tinymce-4.0.26.min.js",
	...
	zip({
		...
		pathFilter: function(args) {
			if (args.zipFilePath == "js/tinymce/tinymce.jquery.min.js") {
				args.zipFilePath = "js/tinymce/tinymce-4.0.26.min.js";
			}
		},

		exclude: [
			"js/tinymce/tinymce.js",
			"js/tinymce/tinymce-4.0.26.min.js",
			"js/tinymce/tinymce.dev.js",
			"js/tinymce/tinymce.full.js",
			"js/tinymce/tinymce.full.min.js",
			"js/tinymce/tinymce.jquery.js",
...
task("zip-component", ["mktmp"], function () {
	...
	zip({
		...
		from: [
			...
			["js/tinymce/tinymce-4.0.26.min.js", "tinymce-4.0.26.min.js"],
			["js/tinymce/jquery.tinymce-4.0.26.min.js", "jquery.tinymce-4.0.26.min.js"],
