...
<%--		{%>--%>
<%--		<script language="javascript">showOperation("<%=prid%>.do?prid=<%=prid%>");</script>--%>
<%--		<%}%>--%>
		...
		<table width="100%" height="100%" border="0" align="center"
				...
				<table width="100%"  border="0" cellpadding="0"
						...
						<logic:notEmpty name="list">
							<logic:iterate id="list" name="list" indexId="index" scope="request">
									<span
										onclick="openReplace('<%=prid%>.do?rfno=<bean:write
                                        name="list"
            ...
            out.print("<tr bgcolor=\"#ECF4FC\" onmouseover=\"this.style.backgroundColor=\'#FFCC99\';\" onmouseout=\"this.style.backgroundColor=\'#ECF4FC\';\">");
             ...
             out.print("<tr bgcolor=\"#ffffff\" onmouseover=\"this.style.backgroundColor=\'#FFCC99\';\" onmouseout=\"this.style.backgroundColor=\'#ffffff\';\">");
								 ...
								 <span
								onclick="openReplace('ViewTelegramText?brno=<bean:write name="list" property="brno" />&mgtp=<bean:write name="list" property="mgtp" />&swid=<bean:write name="list" property="swid" />&swno=<bean:write name="list" property="swno" />&rfno=<bean:write name="list" property="rfno" />&prid=<%=prid%>')">
