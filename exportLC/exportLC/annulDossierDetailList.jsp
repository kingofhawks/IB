	...
	<tr>
		...
		<table width="100%" height="100%" border="0" align="center"
			...
			<tr>
				...
				<div id="innerTable_divLis" style="width:96%"><!-内容开始--><%String cost = com.witsoft.common.Constant.isHaveReceiveDraft(prid,(String)request.getAttribute("tabID"));%>
                <script>showDone("<%if(request.getAttribute("msg")!=null){out.print(request.getAttribute("msg"));}%>");</script>
                <logic:equal
					...
					<table width="100%"  border="0" cellpadding="0"
						...
						<tr>
							...
							<th width="30%"><bean:message key="common.adno" /><!--通知编号--></th>
							<th width="25%"><bean:message key="common.lcno" /><!--信用证编号--></th>
             ...
             out.print("<tr bgcolor=\"#ffffff\" onmouseover=\"this.style.backgroundColor=\'#FFCC99\';\" onmouseout=\"this.style.backgroundColor=\'#ffffff\';\">");
					...
					<table width="100%"  border="0" cellpadding="0"
						...
						<tr>
							...
							<th width="16%"><bean:message key="common.rfno" /><!--流水号--></th>
