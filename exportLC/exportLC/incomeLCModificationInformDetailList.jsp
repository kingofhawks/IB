...
<html:form action="exportLCManageAction.do">
		...
		<table width="100%" height="100%" border="0" align="center"
			...
			<tr>
				...
				<div id="innerTable_divLis" style="width:96%"><!-内容开始--><%String cost = com.witsoft.common.Constant.isHaveReceiveDraft(prid,(String)request.getAttribute("tabID"));%><script>showDone("<%if(request.getAttribute("msg")!=null){out.print(request.getAttribute("msg"));}%>");</script> <logic:equal
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						id="item_list">
						<tr>
							<th width="25%"><bean:message key="common.adno" /><!--通知编号--></th>
							<th width="30%"><bean:message key="common.lcno" /><!--信用证编号--></th>
							<th width="20%"><bean:message key="common.clno" /><!--客户号--></th>
							<th width="25%">银行编号<!--机构号--></th>
						</tr>
							...
							<logic:iterate id="list" name="list" indexId="index" scope="request">
								...
								<span
									<%=cost%>="openReplace('<%=prid%>.do?rfno=<bean:write
                                        name="list" property="id.adno"/>&prid=<%=prid%>')">
             ...
             out.print("<tr bgcolor=\"#ffffff\" onmouseover=\"this.style.backgroundColor=\'#FFCC99\';\" onmouseout=\"this.style.backgroundColor=\'#ffffff\';\">");
					...
					<logic:notEqual name="userCommonForm" property="tabID" value="0">
						<table width="100%" border="0" cellpadding="0" cellspacing="1"
							id="item_list">
			<TR>
								<th width="17%"><bean:message key="common.adno" /><!--通知编号--></th>
								<th width="18%"><bean:message key="common.rfno" /><!--流水号--></th>
								<th width="19%"><bean:message key="common.lcno" /><!--信用证编号--></th>
								<th width="14%"><bean:message key="common.clno" /><!--客户号--></th>
				...
				<logic:equal name="userCommonForm"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						...
						<tr>
							...
							<th width="25%"><bean:message key="common.sentBrno" /></th>
            ...
            out.print("<tr bgcolor=\"#ECF4FC\" onmouseover=\"this.style.backgroundColor=\'#FFCC99\';\" onmouseout=\"this.style.backgroundColor=\'#ECF4FC\';\">");
             ...
             out.print("<tr bgcolor=\"#ffffff\" onmouseover=\"this.style.backgroundColor=\'#FFCC99\';\" onmouseout=\"this.style.backgroundColor=\'#ffffff\';\">");
	                            ...
	                            <span
								onclick="openReplace('ViewTelegramText?brno=<bean:write name="list" property="brno" />&mgtp=<bean:write name="list" property="mgtp" />&swid=<bean:write name="list" property="swid" />&rfno=<bean:write name="list" property="rfno" />&tstp=<bean:write name="list" property="tstp" />&prid=<%=prid%>')">
