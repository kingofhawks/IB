	...
	<tr>
		...
		<table width="100%" height="100%" border="0" align="center"
			...
			<tr>
				...
				<div id="innerTable_div"><!--内容开始--> <html:form action="ELUK.do"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<table width="375" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td height="20" align="right" valign="top">修改号：</td>
									<td valign="top"><html:text property="aeno" readonly="true" /></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top" class="attR">*拒绝/接收：</td>
									<td valign="top">
									<div class="sele_div"><html:select property="rvst" title="rvst">
										<%out.println(request.getAttribute("OPTION_RVST"));%>
									</html:select></div>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td height="20" align="right" valign="top">费用类型：</td>
									<td valign="top">
      ...
      if(draftFlag){%>
		...
		onClick="openReplace('/IB/voucher.do?prid=<bean:write name="declineOrAcceptModificationDetailForm" property="prid"/>&step=<%=step%>&flag=flag&rfno=<bean:write name="declineOrAcceptModificationDetailForm" property="rfno"/>&no=<bean:write name="declineOrAcceptModificationDetailForm" property="adno"/>');return false">&nbsp;&nbsp;
		
		<%if(tabID!=null&&tabID.equals("6")){//流程图，只能在以生效里面看到%>
		<input	type="image" src="<bean:message key="common.svg" />"
		onClick="window.open('/IB/flowchart.do?id=<bean:write name="declineOrAcceptModificationDetailForm" property="adno"/>&prid=<bean:write name="declineOrAcceptModificationDetailForm" property="prid"/>','newwindow','toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no');return false">&nbsp;&nbsp;
		<%}
          }
		...
		onClick="openReplace('exportLCManageAction.do?tabID=<%=tabID%>&prid=<bean:write name="declineOrAcceptModificationDetailForm" property="prid"/>');return false">
