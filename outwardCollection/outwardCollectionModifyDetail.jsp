...
var amts=parseInt(f.amts.value);//信用证余额
var zen = f.adsn.value;//增减金额标记

if(f.adam.value==''||f.adam.value==null){
var temp =parseInt("0");
}else{
var temp = parseInt(f.adam.value);//增减金额
}
...
if(zen=='+'){
last =amts+ temp;
document.forms[0].upam.value=last;
}else{
if(amts<temp){
alert("增减的金额大于托收金额！");
...
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
                ...
                <tr>
                    ...
                    <td align="center" class="innerTable_main">
                        <div id="innerTable_div"  class="kuangScroll">
                            ...
                            <!--内容开始-->
                            <html:form action="OCUP.do" onsubmit="checkForm(this)" method="post">
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
									...
									<html:option value="<%=cyno[0]%>"><%=cyno[1]%></html:option>	
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">增减标识：</td>
                                                <td valign="top">
                                                    
                                                     <div class="sele_div"><html:select
                                        property="adsn"  onchange="adds()">
                                        <%out.println(request.getAttribute("OPTION_ADSN"));%>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top"><html:text property="adam" onkeypress="regInput(/^\d{1,}\.?\d{0,2}$/)" style="ime-mode:Disabled" maxlength="15" onclick="adds()" onblur="adds()"/></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*修改后金额：</td>
                                                <td valign="top"><html:text title="upam" property="upam" onkeypress="regInput(/^\d{1,}\.?\d{0,2}$/)" style="ime-mode:Disabled" maxlength="15" onclick="adds()"/></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <td width="50%" valign="top">
                                        <table width="375" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top"><html:text title="blpy" property="blpy" maxlength="42"/></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">交易类型：</td>
                                                <td valign="top">
                                        ...
                                        <%out.println(request.getAttribute("OPTION_TYTP"));%>
                                            ...
                                            <tr>
                                                <td width="40%" height="20" align="right" valign="top" class="attR">*发票号：</td>
                                                <td valign="top"><html:text title="ivno" property="ivno" maxlength="16"/>
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <%out.println(request.getAttribute("OPTION_TLTP"));%>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top">
                                                 <div class="sele_div"><html:select styleClass="coin" property="tlcy">
									            <option></option>
										        <logic:notEmpty name="OPTION_CYNO">
              						            <logic:iterate id="list" name="OPTION_CYNO">
									            <%String[] cyno = (String[])list;%>
      ...
      if(draftFlag){%>
		...
		%>
		<input type="image" src='<bean:message key="common.report" />' onClick="openReplace('/IB/voucher.do?prid=<bean:write name="outwardCollectionModifyDetailForm" property="prid"/>&step=<%=step%>&flag=flag&rfno=<bean:write name="outwardCollectionModifyDetailForm" property="rfno"/>&no=<bean:write name="outwardCollectionModifyDetailForm" property="ocno"/>');return false">&nbsp;&nbsp;
		<%if(tabID!=null&&tabID.equals("6")){//流程图，只能在以生效里面看到%>
	<input type="image" src='<bean:message key="common.svg" />' onClick="window.open('/IB/flowchart.do?id=<bean:write name="outwardCollectionModifyDetailForm" property="ocno"/>&prid=<bean:write name="outwardCollectionModifyDetailForm" property="prid"/>','newwindow','toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no');return false">&nbsp;&nbsp;
		<%}
          }
		...
		<%}%>
		<input type="image" src='<bean:message key="common.returnList" />' onClick="openReplace('outwardCollectionManageAction.do?tabID=<%=tabID%>&prid=<bean:write name="outwardCollectionModifyDetailForm" property="prid"/>');return false">
