...
function sendData()
{
    ...
    //  {
     ...
     //    rt = rt + "document.getElementById(\"" + myObj[i] +"\").value='" + (rtValue[1] ? rtValue[1] : "") +"';"
     // }
      
      rt = "document.getElementById(\"" + mystr +"\").value='" + (rtValue ? rtValue : "") +"';"
...
function ck(trObj)
{
   ...
   // rtValue[0] = window.event.srcElement.parentNode.firstChild.innerText;
    rtValue =  window.event.srcElement.parentNode.childNodes[1].innerText;
...
<table width="780" height="340" border="0" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td valign="top">
            ...
            <html:form action="bankAction.do?sign=true" method="post">
                <tr>
                    <td width="258" height="88" align="left" nowrap>
...
<a id="reload" href="/IB/file/bank1.jsp" style="display:none">reload...</a>
</body>
</html>
