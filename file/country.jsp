...
<table width="386" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<table width="386" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td height="25">&nbsp;</td>
				<td align="right"><input type="button" name="Submit3" value="刷 新"
					onclick="reload.click()"><!--coinAction.do --></td>
			</tr>
		</table>
					...
					<logic:notEmpty name="list">
						<logic:iterate id="list" name="list" indexId="index" scope="request"> 
								...
								<td><input name="coinBtn" type="radio" onclick="radionClick()"
									value='' checked></td>
								<td><bean:write name="list" property="swcd" /></td>
								<td><bean:write name="list" property="ctnm" /></td>
							</tr>
						</logic:iterate>
					</logic:notEmpty>
				</table>
...
<a id="reload" href="/IB/countryAction.do" style="display:none">reload...</a>
<script>
