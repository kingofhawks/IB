...
<table width="650"  border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td><html:form action="accountsAction.do">
			...
			<tr>
				<td width="300" height="75">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td align="right" width="100">客户帐号：</td>
						...
						<tr>
							...
							<html:hidden property="adl1"  value="acno"/>
				...
				<table width="80" height="75" border="0" cellpadding="0"
					cellspacing="0">
					<tr>
					  <td align="center" valign="bottom"><input type="button" name="Submit" value="提 交"
							onclick="sendData()" class="btn"></td>
					</tr>
					<tr>
					  <td align="center" valign="bottom"><input type="button" name="Submit2" value="退 出"
							onclick="window.close()" class="btn"></td>
					</tr>
					<tr>
					  <td align="center" valign="bottom"><input type="submit" name="Submit" value="查 找" class="btn"></td>
					</tr>
					<tr>
						<td></td>
					</tr>
