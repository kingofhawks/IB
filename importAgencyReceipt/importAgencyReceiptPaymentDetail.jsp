                                ...
                                <tr>
                                    <td width="50%" valign="top">                                        
                                        <table width="375" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">跟单托收编号：</td>
										...
										<logic:notEmpty name="OPTION_CYNO">
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*付款金额：</td>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">实付金额：</td>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">帐号：</td>
                                                <td valign="top"><html:text property="acacno" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">帐户行内部识别号：</td>
                                                <td valign="top"><html:text property="acinac" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">帐户行SWIFT NO： </td>
                                                <td valign="top"><html:text property="acswno" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">中间行：</td>
                                                <td valign="top">
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">中间行名称：</td>
                                                <td valign="top"><html:text property="mdbknm" readonly="true"/></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">中间行地址：</td>
                                                <td valign="top"><html:textarea property="mdbkad" readonly="true"></html:textarea></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">中间行SWIFT：</td>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">现汇支付金额：</td>
									...
									<div></td>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*对公对私：</td>
                                                <td valign="top">
