                                ...
                                <tr>
										...
										title="<bean:message key='teles.tobk.title'/>'" readonly="true" />&nbsp;<html:image src="/IB/images/winsearch.gif" tabindex="1" property="more_btn" onclick="openWin('bank','tobk');return false"></html:image>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top"class="attR">*20:
                                                    Transaction Reference Numberl</td>
                                                <td valign="middle">&nbsp;
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top"class="attR">*32A:
                                                    Maturity Date, Currency Code,
                                                    Amount Accepted</td>
                                                <td valign="middle">&nbsp;
                                                    <input name="_32aa" title="<bean:message key='teles.32aa.title'/>" type="text" class="32a1" value="<%if(map.get("_32aa") != null){out.print(map.get("_32aa"));}%>">
                                                    <input name="_32ab" title="<bean:message key='teles.32ab.title'/>" type="text" class="32a2" value="<%if(map.get("_32ab") != null){out.print(map.get("_32ab"));}%>">
                                                    <input name="_32ac" title="<bean:message key='teles.32ac.title'/>" type="text" class="32a3" value="<%if(map.get("_32ac") != null){out.print(map.get("_32ac"));}%>">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td height="20" valign="middle">&nbsp;
                                                    <input type="text" name="_52ac" title="<bean:message key='teles._52ac.title'/>"value="<%if(map.get("_52ac") != null){out.print(map.get("_52ac"));}%>" title="_52ac"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td height="20" valign="middle">&nbsp;
                                                    <textarea name="_53dc" title="<bean:message key='teles._53dc.title'/>"> <%if(map.get("_53dc") != null){out.print(map.get("_53dc"));}%></textarea></td>
                                            </tr>
                                             <tr>
                                                            ...
                                                            <td>
                                                                <div class="sele_div1">
                                                                    <select name="_54aa" class="select1">
                                                                        <%out.println(ConvertOptions.ConvertArrayToString(bean.findByOptions("OPTION_BSUBF"), (String)map.get("4")));%>
                                                                    </select>
                                                                </div>
                                                            </td>
                                                        </tr>
                                    ...
                                    <td width="50%" valign="top">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                             <tr>
                                                <td rowspan="3" align="right" valign="top">56A:Intermediary</td>
                                                <td height="20" align="center" valign="middle">
                                                    <table width="94%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td>
                                            ...
                                            <tr>
                                                <td height="20" valign="middle">&nbsp;
                                                    <input type="text" name="_56ab"title="<bean:message key='teles._52ab.title'/>"  value="<%if(map.get("_56ab") != null){out.print(map.get("_56ab"));}%>"></td>
                                            </tr>
                                            <tr>
                                                <td height="20" valign="middle">&nbsp;
                                                    <input type="text" name="_56ac"title="<bean:message key='teles._56ac.title'/>" value="<%if(map.get("_56ac") != null){out.print(map.get("_56ac"));}%>"></td>
                                            </tr>
                                            <tr>
                                                <td rowspan="3" align="right" valign="top">56D:Intermediary</td>
                                                <td height="20" align="center" valign="middle">
                                                    <table width="94%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td>
                                            ...
                                            <tr>
                                                <td height="20" valign="middle">&nbsp;
                                                    <input type="text" name="_56db" title="<bean:message key='teles._52ab.title'/>" value="<%if(map.get("_56db") != null){out.print(map.get("_56db"));}%>"></td>
                                            </tr>
                                            <tr>
                                                <td height="20" valign="middle">&nbsp;
                                                    <textarea name="_56dc" title="<bean:message key='teles._56dc.title'/>"> <%if(map.get("_56dc") != null){out.print(map.get("_56dc"));}%></textarea></td>
                                            </tr>
                                             <tr>
                                                <td rowspan="3" align="right" valign="top">57A:Account
                                                    With Institution</td>
                                                <td height="20" align="center" valign="middle">
                                                    <table width="94%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                            ...
                                            <tr>
                                                <td height="20" valign="middle">&nbsp;
                                                    <textarea name="_57dc" title="<bean:message key='teles._57dc.title'/>" > <%if(map.get("_57dc") != null){out.print(map.get("_57dc"));}%></textarea></td>
                                            </tr>
                                             <tr>
                                            ...
                                            <tr>
                                                <td rowspan="2" align="right" valign="top">58D:Beneficiary
                                                    Institution</td>
                                                <td height="20" align="center" valign="middle">
                                                    <table width="94%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
