                                    ...
                                    <td width="50%" valign="top">                                        
                                        <table width="529" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td valign="middle">&nbsp;
                                                    <input name="_27" type="text"  maxlength="3" size ="3" title="<bean:message key='teles.700._27.title'/>"  value="<%if(map.get("_27") != null){out.print(map.get("_27"));}%>" title="_27"></td></tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">45B:Description of Good and /or Services </td>
                                                <td valign="middle">&nbsp;
                                                    <textarea name="_45b" title="<bean:message key='teles.700._45a.title'/>" > <%if(map.get("_45b") != null){out.print(map.get("_45b"));}%></textarea></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">46B:Documents Required</td>
                                                <td valign="middle">&nbsp;
