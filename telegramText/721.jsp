                                ...
                                <tr>
                                    <td width="50%" valign="top">                                        
                                        <table width="500" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td width="46%" height="20" align="right" valign="top" class="attR">*FM: +Sender&nbsp;</td>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">21: Reference to Pre-Advice</td>
                                                <td valign="middle">&nbsp;
                                                    <input type="text" name="_21" title="<bean:message key='teles.700._23.title'/>" value="<%if(map.get("_21") != null){out.print(map.get("_21"));}%>"></td>
                                            </tr>
                                            <tr>
