                                    ...
                                    <td width="50%" valign="top">                                        
                                        <table width="398" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td valign="middle">&nbsp;
                                                    <input type="text" name="fmbk" maxlength="12" value="<%if(map.get("fmbk") != null){out.print(map.get("fmbk"));}%>" title='<bean:message key="teles.fmbk.title" />'></td></tr>
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*TO: +Receiver&nbsp;</td>
                                                <td valign="middle">&nbsp;
                                                 <input type="text" name="tobk"  maxlength="12"  title='<bean:message key="teles.tobk.title" />' value="<%if(map.get("tobk") != null){out.print(map.get("tobk"));}%>"
										title="tobk" readonly="true" />&nbsp;<html:image src="/IB/images/winsearch.gif" tabindex="1" property="more_btn" onclick="openWin('bank','tobk');return false"></html:image>
                                                 </td></tr>
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*20: Transaction Reference Number </td>
                                                <td valign="middle">&nbsp;
                                                    <input type="text"  name="_20"  maxlength="16" value="<%if(map.get("_20") != null){out.print(map.get("_20"));}%>" title='<bean:message key="teles._20.title" />'>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">21: Related Reference</td>
                                                <td valign="middle">&nbsp; <input type="text" name="_21" value="<%if(map.get("_21") != null){out.print(map.get("_21"));}%>" title='<bean:message key="teles._21.title" />'></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*79:DESCRIPTION RELATED MESSAGE</td>
                                                <td valign="middle">&nbsp;
    <textarea  name="_79"title='<bean:message key="teles._79.title" />'> <%if(map.get("_79") != null){out.print(map.get("_79"));}%></textarea></td></tr>
                                        </table>
                                    </td>
