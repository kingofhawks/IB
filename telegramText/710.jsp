                                ...
                                <tr>
                                    <td width="50%" valign="top">                                        
                                        <table width="396" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*40B: +Form of Documentary Credit</td>
                                                <td valign="middle">&nbsp;
                                                    <input type="text" name="_40b" title="<bean:message key='teles.700._40a.title'/>" value="<%if(map.get("_40b") != null){out.print(map.get("_40b"));}%>" title="_40b"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*21: Documentary Credit Number </td>
                                                <td valign="middle">&nbsp;
                                                    <input type="text" name="_21" title="<bean:message key='teles.700._20.title'/>"  value="<%if(map.get("_21") != null){out.print(map.get("_21"));}%>" title="_21">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">23: Reference to Pre-Advice</td>
                                                <td valign="middle">&nbsp;
                                                    <input type="text"  name="_23"  title="<bean:message key='teles.700._23.title'/>" maxlength="16" value="<%if(map.get("_23") != null){out.print(map.get("_23"));}%>"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="middle">&nbsp;
                                                    <input  name="_31da"  maxlength="6" title="<bean:message key='teles.700._31da.title'/>" type="text" class="date1" value="<%if(map.get("_31da") != null){out.print(map.get("_31da"));}%>" title="_31da">
                                                    <br>
                                                    &nbsp;
                                            ...
                                            <tr>
                                                ...
                                                <div style="float:right; ">:Issuing Bank </div></div>
													</td>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top"><div style="float:right; width:128px;"><div class="sele_div1" style="float:left; width:43px;">
                                                        <select name="_51a" class="select1" style="width:45px; ">
...
<%out.println(ConvertOptions.ConvertArrayToString(bean.findByOptions("OPTION_BSUBF"), (String)map.get("_51a")));%> 
                                                ...
                                                <td align="center" valign="middle">
                                                    <table width="94%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td>
                                                                <div class="sele_div1">
                                                                    <select  name="_51b"  maxlength="34" class="select1">
                                                                        <%out.println(ConvertOptions.ConvertArrayToString(bean.findByOptions("OPTION_BSUBF"), (String)map.get("_51b")));%>
                                                                        <%out.println(ConvertOptions.ConvertArrayToString(bean.findByOptions("OPTION_BSUBF"), (String)map.get("_51b")));%>
                                                                    </select>
                                                                </div>
                                                            </td>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">&nbsp;</td>
                                                <td valign="middle">&nbsp;
                                                    <input type="text" name="_51c"  title="<bean:message key='teles._52ab.title'/>" maxlength="34"  value="<%if(map.get("_51c") != null){out.print(map.get("_51c"));}%>"></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">&nbsp;</td>
                                                <td valign="middle">&nbsp;
                                                    <textarea name="_51d" title="<bean:message key='teles.707._52ac.title'/>" > <%if(map.get("_51d") != null){out.print(map.get("_51d"));}%></textarea></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="middle">&nbsp;
                                                    <input name="_32ba"  maxlength="3" title="<bean:message key='teles.400._32kd.title'/>" type="text" class="currency1" value="<%if(map.get("_32ba") != null){out.print(map.get("_32ba"));}%>" title="_32ba">
                                                    <input name="_32bb"  maxlength="15" title="<bean:message key='teles.400._32ke.title'/>" type="text" class="amount1" value="<%if(map.get("_32bb") != null){out.print(map.get("_32bb"));}%>"></td>
                                            </tr>
                                            <tr>
                                        ...
                                        <table width="375" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top"><div style="float:right; width:134px;"><div class="sele_div1" style="float:left; width:43px;">
                                                        <select name="_53a" class="select1" style="width:45px; ">
                                                            
<%out.println(ConvertOptions.ConvertArrayToString(bean.findByOptions("OPTION_BSUBF"), (String)map.get("_53a")));%> 
                                                           
<%out.println(ConvertOptions.ConvertArrayToString(bean.findByOptions("OPTION_BSUBF"), (String)map.get("_53a")));%> 
                                                        </select>
                                                    </div><div style="float:right; ">:Reimbursing Bank </div></div></td>
                                                <td align="center" valign="middle">
                                                    <table width="94%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td>
                                                                <div class="sele_div1">
                                                                    <select name="_53b" class="select1">
                                                                        <%out.println(ConvertOptions.ConvertArrayToString(bean.findByOptions("OPTION_BSUBF"), (String)map.get("_53b")));%>
                                                                        <%out.println(ConvertOptions.ConvertArrayToString(bean.findByOptions("OPTION_BSUBF"), (String)map.get("_53b")));%>
                                                                    </select>
                                                                </div>
                                                            </td>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">&nbsp;</td>
                                                <td valign="middle">&nbsp;
                                                    <input type="text" name="_53c" title="<bean:message key='teles._52ab.title'/>" value="<%if(map.get("_53c") != null){out.print(map.get("_53c"));}%>"></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">&nbsp;</td>
                                                <td valign="middle">&nbsp;
                                                    <textarea name="_53d" title="<bean:message key='teles.700._53dc.title'/>" > <%if(map.get("_53d") != null){out.print(map.get("_53d"));}%></textarea></td>
                                            </tr>
                                            <tr>
...
<%out.println(ConvertOptions.ConvertArrayToString(bean.findByOptions("OPTION_BSUBF"), (String)map.get("_57a")));%> >
                                                    ...
                                                    </div><div style="float:right; ">:"Advise Through" Bank </div></div></td>
                                                <td align="center" valign="middle">
                                                    <table width="94%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td>
