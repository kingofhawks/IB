                                ...
                                <tr>
                                    <td width="50%" valign="top">                                        
										...
										title="<bean:message key='teles.tobk.title'/>" readonly="true" />&nbsp;<html:image src="/IB/images/winsearch.gif" tabindex="1" property="more_btn" onclick="openWin('bank','tobk');return false"></html:image>
                                            ...
                                            <tr id="1_1">
                                                <td height="20" align="right" valign="top"class="attR">*20:TRNSender's
                                                    ReferenceTRN </td>
                                                <td valign="middle">&nbsp;
                                                    <input type="text" name="_20" title="<bean:message key='teles.420._20.title'/>" value="<%if(map.get("_20") != null){out.print(map.get("_20"));}%>">
                                                </td>
                                            </tr>
                                            <tr id="1_2">
                                            ...
                                            <tr id="1_3">
                                                <td height="20" align="right" valign="top">32A:
                                                    Amount Tracedt</td>
                                                <td valign="middle">&nbsp;
                                                    <input name="_32aa" type="text" title="<bean:message key='teles.32aa.title'/>" class="32a1" value="<%if(map.get("_32aa") != null){out.print(map.get("_32aa"));}%>" title="_32aa">
                                            ...
                                            <tr id="1_4">
                                                ...
                                                <td valign="middle">&nbsp;
                                                    ...
                                                    <input name="_32bb" type="text" title="<bean:message key='teles.32ac.title'/>" class="32a3" value="<%if(map.get("_32bb") != null){out.print(map.get("_32bb"));}%>">
                                                </td>
                                            </tr>
                                            <tr id="1_5">
                                                <td height="20" align="right" valign="top">32K:
                                                    Amount Tracedt</td>
                                                <td valign="middle">&nbsp;
                                                    <input name="_32ka" type="text" title="<bean:message key='teles.400._32ka.title'/>" class="32k1" value="<%if(map.get("_32ka") != null){out.print(map.get("_32ka"));}%>">
                                                    <input name="_32kb" type="text" title="<bean:message key='teles.400._32kb.title'/>" class="32k2" value="<%if(map.get("_32kb") != null){out.print(map.get("_32kb"));}%>">
                                                    <input name="_32kc" type="text" title="<bean:message key='teles.400._32kc.title'/>" class="32k3" value="<%if(map.get("_32kc") != null){out.print(map.get("_32kc"));}%>">
                                                    <input name="_32kd" type="text" title="<bean:message key='teles.400._32kd.title'/>" class="32k4" value="<%if(map.get("_32kd") != null){out.print(map.get("_32kd"));}%>">
                                                    <input name="_32ke" type="text" title="<bean:message key='teles.400._32ke.title'/>" class="32k5" value="<%if(map.get("_32ke") != null){out.print(map.get("_32ke"));}%>">
                                                </td>
                                            </tr>
                                            <tr id="2_1">
                                                <td height="20" align="right" valign="top">20:TRNSender's
                                                    ReferenceTRN </td>
                                                <td valign="middle">&nbsp;
                                            ...
                                            <tr id="2_3">
												<td height="20" align="right" valign="top">32A: Amount Traced</td>
                                                <td valign="middle">&nbsp;
                                            ...
                                            <tr id="2_5">
                                                <td height="20" align="right" valign="top">32K:
                                                    Amount Traced</td>
                                                <td valign="middle">&nbsp;&nbsp;
                                                    <input name="_32ka" type="text" class="32k1" value="<%if(map.get("_32ka") != null){out.print(map.get("_32ka"));}%>">
                                                    <input name="_32kb" type="text" class="32k2" value="<%if(map.get("_32kb") != null){out.print(map.get("_32kb"));}%>">
                                                    <input name="_32kc" type="text" class="32k3" value="<%if(map.get("_32kc") != null){out.print(map.get("_32kc"));}%>">
                                                    <input name="_32kd" type="text" class="32k4" value="<%if(map.get("_32kd") != null){out.print(map.get("_32kd"));}%>">
                                                    <input name="_32ke" type="text" class="32k5" value="<%if(map.get("_32ke") != null){out.print(map.get("_32ke"));}%>">
                                                </td>
                                            </tr>
                                            <tr id="3_1">
                                                <td height="20" align="right" valign="top">20:TRNSender's
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">30:
                                                    Date of Collection Instruction </td>
                                                <td valign="middle">&nbsp;
                                                    <input name="_30" type="text" title="<bean:message key='teles.420._30.title'/>"  class="date" value="<%if(map.get("_30") != null){out.print(map.get("_30"));}%>">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="middle">&nbsp;
                                                    <textarea  name="textarea2" title="<bean:message key='teles._72.title'/>" > <%if(map.get("textarea2") != null){out.print(map.get("textarea2"));}%></textarea>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
