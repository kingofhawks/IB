                                ...
                                <tr>
                                    <td width="50%" valign="top">                                        
                                        <table width="375" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td width="51%" height="20" align="right" valign="top" class="attR">*FM: +Sender&nbsp;</td>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">30:Date</td>
                                                <td valign="middle">&nbsp;
                                                    <input type="text" name="_30"   title="<bean:message key='teles.760._30.title'/>" maxlength="6"  value="<%if(map.get("_30") != null){out.print(map.get("_30"));}%>"></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">77C:: Details of Guarantee</td>
                                                <td valign="middle">&nbsp;
                                                    <textarea name="_77c" title="<bean:message key='teles.760._77c.title'/>" > <%if(map.get("_77c") != null){out.print(map.get("_77c"));}%></textarea></td>
                                            </tr>
                                            <tr>
