...
<table width="100%" height="100%" border="0" align="center"
	...
	<tr>
		...
		<table width="100%" height="100%" border="0" align="center"
			...
			<tr>
				...
				<div id="innerTable_div" class="kuangScroll"><!--内容开始--> <html:form
					action="IBPY.do" onsubmit="checkForm(this)"
					method="post">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<table width="375" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td height="20" align="right" valign="top">收款行：</td>
									<td valign="top"><html:text styleClass="bank" property="rvbk" readonly="true"/></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td valign="top"><html:textarea property="rvbkad" readonly="true"></html:textarea></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">收款行之帐户行：</td>
									<td valign="top"><html:text styleClass="bank" property="rabk" readonly="true"/>
									<html:image src="/IB/images/winsearch.gif" tabindex="1" property="more_btn" onclick="openWin('bank','rabk,rabknm,rabkad');return false"></html:image></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td valign="top"><html:textarea property="rabkad" readonly="true"></html:textarea></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td valign="top"><html:text styleClass="bank" property="acbk"
										title="acbk" readonly="true" /> <html:image src="/IB/images/winsearch.gif" tabindex="1" property="more_btn" onclick="openWin('bank','acbk,acbkad');return false"></html:image></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td valign="top"><html:text property="acc1" readonly="true"/></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td valign="top"><html:text property="acc4" maxlength="35"/></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td valign="top"><html:text property="acc5" maxlength="35"/></td>
								</tr>
								<tr>
							...
							<table width="375" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td valign="top"><html:text property="acc6" maxlength="36"/></td>
								</tr>
								<tr>
								...
								<tr>
									<td height="20" align="right" valign="top">套汇汇率：</td>
									<td valign="top"><html:text property="exr1" maxlength="12"/></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">套汇后金额：</td>
									<td valign="top"><html:text property="dram" onkeypress="regInput(/^\d{1,}\.?\d{0,2}$/)" style="ime-mode:Disabled" readonly="true"/></td>
								</tr>
								<tr>
								...
								<tr>
									<td height="20" align="right" valign="top">是否凭备案表付汇：</td>
									<td valign="top">
								...
								<tr>
									<td height="20" align="right" valign="top">是否凭异地付汇：</td>
									<td valign="top">
								...
								<tr>
									...
									<div class="sele_div"><html:select property="chfr" title="chfr"> 
								...
								<tr>
									...
									<td valign="top"><html:text styleClass="date" property="crdt" readonly="true"/>
								...
								<tr>
									...
									<td valign="top"><html:text property="mgac" maxlength="16" readonly="true"/></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">币种：</td>
									<td valign="top">
									<div class="sele_div"><html:select styleClass="coin"
										property="accy" disabled="true">
										<option></option>
										<logic:notEmpty name="OPTION_CYNO">
											<logic:iterate id="list" name="OPTION_CYNO">
												<%String[] cyno = (String[]) list;%>
								...
								<tr>
									<td height="20" align="right" valign="top">金额：</td>
									<td valign="top"><html:text property="mgam" onkeypress="regInput(/^\d{1,}\.?\d{0,2}$/)" style="ime-mode:Disabled" readonly="true" /></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">使用保证金金额：</td>
									<td valign="top"><html:text property="mgtmp" readonly="true"/></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">折成付汇币种金额：</td>
									<td valign="top"><html:text property="mgchgamt" readonly="true"/></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">保证金帐号二：</td>
									<td valign="top"><html:text property="mgc2" maxlength="36" readonly="true"/></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">币种：</td>
									<td valign="top">
									<div class="sele_div"><html:select styleClass="coin"
										property="acy2" disabled="true">
										<option></option>
										<logic:notEmpty name="OPTION_CYNO">
											<logic:iterate id="list" name="OPTION_CYNO">
												<%String[] cyno = (String[]) list;%>
								...
								<tr>
									<td height="20" align="right" valign="top">金额：</td>
									<td valign="top"><html:text property="mam2" readonly="true"/></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">使用保证金金额：</td>
									<td valign="top"><html:text property="mgtmp2" readonly="true"/></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">折成付汇币种金额：</td>
									<td valign="top"><html:text property="mgchgamt1" readonly="true"/></td>
								</tr>
							</table>
							</td>
						</tr>
      ...
      if(draftFlag){%>
		...
		onClick="openReplace('/IB/voucher.do?prid=<bean:write name="importBillPaymentDetailForm" property="prid"/>&step=<%=step%>&flag=flag&rfno=<bean:write name="importBillPaymentDetailForm" property="rfno"/>&no=<bean:write name="importBillPaymentDetailForm" property="ibno"/>');return false">&nbsp;&nbsp;
		
		<%if(tabID!=null&&tabID.equals("6")){//流程图，只能在以生效里面看到%>
		<input	type="image" src='<bean:message key="common.svg" />'
		onClick="window.open('/IB/flowchart.do?id=<bean:write name="importBillPaymentDetailForm" property="ibno"/>&prid=<bean:write name="importBillPaymentDetailForm" property="prid"/>','newwindow','toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no');return false">&nbsp;&nbsp;
		<%}
          }
		...
		onClick="openReplace('importBillManageAction.do?tabID=<%=tabID%>&prid=<bean:write name="importBillPaymentDetailForm" property="prid"/>');return false">
