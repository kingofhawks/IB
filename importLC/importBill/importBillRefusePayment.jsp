	...
	<tr>
		...
		<table width="100%" height="100%" border="0" align="center"
			...
			<tr>
				...
				<div id="innerTable_div"><!--内容开始--> <html:form action="IBRJ.do"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<table width="375" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td height="20" align="right" valign="top">进口来单币种：</td>
									<td valign="top">
								...
								<tr>
									<td height="20" align="right" valign="top">进口来单金额：</td>
									<td valign="top"><html:text property="dlam" onkeypress="regInput(/^\d{1,}\.?\d{0,2}$/)" style="ime-mode:Disabled"/></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">议付行：</td>
									<td valign="top"><html:text property="ngbk" readonly="true" /></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">议付行名称：</td>
									<td valign="top"><html:text property="ngbknm" readonly="true" />
									</td>
								</tr>
								<tr>
      ...
      if(draftFlag){%>
		...
		onClick="openReplace('/IB/voucher.do?prid=<bean:write name="importBillRefusePaymentForm" property="prid"/>&step=<%=step%>&flag=flag&rfno=<bean:write name="importBillRefusePaymentForm" property="rfno"/>&no=<bean:write name="importBillRefusePaymentForm" property="ibno"/>');return false">&nbsp;&nbsp;
		
		<%if(tabID!=null&&tabID.equals("6")){//流程图，只能在以生效里面看到%>
		<input	type="image" src='<bean:message key="common.svg" />'
		onClick="window.open('/IB/flowchart.do?id=<bean:write name="importBillRefusePaymentForm" property="ibno"/>&prid=<bean:write name="importBillRefusePaymentForm" property="prid"/>','newwindow','toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no');return false">&nbsp;&nbsp;
		<%}
          }
		...
		onClick="openReplace('importBillManageAction.do?tabID=<%=tabID%>&prid=<bean:write name="importBillRefusePaymentForm" property="prid"/>');return false">
