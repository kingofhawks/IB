...
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
                ...
                <tr>
                    ...
                    <td align="center" class="innerTable_main">
                        <div id="innerTable_div" class="kuangScroll">
                            ...
                            <!--内容开始-->
                            <html:form action="IBDR.do" onsubmit="checkForm(this)" method="post">
                                  ...
                                  <td width="50%" valign="top">                                        
                                        <table width="375" border="0" cellpadding="0" cellspacing="0">
                                         <tr>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">申请人(客户号)：</td>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*通知日期：</td>
                                                <td valign="top">
                                                    <html:text styleClass="date" title="ardt" property="ardt" readonly="true"/>
                                                    <html:image src="/IB/images/date.gif" tabindex="1" property="more_btn" onclick="openWin('date','ardt');return false"></html:image></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">议付行：</td>
                                                <td valign="top"><html:text styleClass="bank" property="ngbk" readonly="true"/>
                                                    <html:image src="/IB/images/winsearch.gif" tabindex="1" property="more_btn" onclick="openWin('bank','ngbk,ngbknm,ngbkad');return false"></html:image></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*单据币种：</td>
									...
									<html:option value="<%=cyno[0]%>"><%=cyno[1]%></html:option>	
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*单据金额：</td>
      ...
      if(draftFlag){%>
		...
		onClick="openReplace('/IB/voucher.do?prid=<bean:write name="discrepancyIdentlfiedCheckInDetailForm" property="prid"/>&step=<%=step%>&flag=flag&rfno=<bean:write name="discrepancyIdentlfiedCheckInDetailForm" property="rfno"/>&no=<bean:write name="discrepancyIdentlfiedCheckInDetailForm" property="ibno"/>');return false">&nbsp;&nbsp;
		
		<%if(tabID!=null&&tabID.equals("6")){//流程图，只能在以生效里面看到%>
		<input	type="image" src='<bean:message key="common.svg" />'
		onClick="window.open('/IB/flowchart.do?id=<bean:write name="discrepancyIdentlfiedCheckInDetailForm" property="ibno"/>&prid=<bean:write name="discrepancyIdentlfiedCheckInDetailForm" property="prid"/>','newwindow','toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no');return false">&nbsp;&nbsp;
		<%}
          }
		...
		onClick="openReplace('importBillManageAction.do?tabID=<%=tabID%>&prid=<bean:write name="discrepancyIdentlfiedCheckInDetailForm" property="prid"/>');return false">
