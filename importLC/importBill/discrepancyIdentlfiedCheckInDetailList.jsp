...
<table width="100%" height="100%" border="0" align="center"
	...
	<tr>
		...
		<td class="outerTable_head"><script language="javascript">showTab("<%=request.getAttribute("opid")%>");</script><!--script
			language="javascript">showOperation("/IB/discrepancyIdentlfiedCheckInDetail.do");</script--></td>
...
<logic:notEqual name="userCommonForm"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						id="item_list">
						<tr>
							<th width="17%"><bean:message key="common.ibno" /></th>
							<th width="27%"><bean:message key="common.rfno" /></th>
							<th width="17%"><bean:message key="common.lcno" /></th>
							<th width="17%"><bean:message key="common.clno" /></th>
							<th width="17%">银行编号</th>
							<th width="22%"><bean:message key="common.dldt" /></th>
						</tr>
						<logic:notEmpty name="list">
							<logic:iterate id="list" name="list" indexId="index" scope="request">
								<span
