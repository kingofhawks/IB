...
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
            ...
            <table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="center" class="innerTable_main">
                        <div id="innerTable_div"><!--内容开始--><html:form action="IBUM.do"
                                ...
                                <tr>
                                    <td width="50%" valign="top">                                        
                                        <table width="375" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">承兑金额：</td>
                                                <td valign="top"><html:text property="dlam" onkeypress="regInput(/^\d{1,}\.?\d{0,2}$/)" style="ime-mode:Disabled"/></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*新到期日：</td>
                                                <td valign="top">
      ...
      if(draftFlag){%>
		...
		onClick="openReplace('/IB/voucher.do?prid=<bean:write name="changeAcceptMaturityDetailForm" property="prid"/>&step=<%=step%>&flag=flag&rfno=<bean:write name="changeAcceptMaturityDetailForm" property="rfno"/>&no=<bean:write name="changeAcceptMaturityDetailForm" property="ibno"/>')">&nbsp;&nbsp;
		
		<%if(tabID!=null&&tabID.equals("6")){//流程图，只能在以生效里面看到%>
		<input	type="image" src='<bean:message key="common.svg" />'
		onClick="window.open('/IB/flowchart.do?id=<bean:write name="changeAcceptMaturityDetailForm" property="ibno"/>&prid=<bean:write name="changeAcceptMaturityDetailForm" property="prid"/>','newwindow','toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no');return false">&nbsp;&nbsp;
		<%}
          }
		...
		onClick="openReplace('importBillManageAction.do?tabID=<%=tabID%>&prid=<bean:write name="changeAcceptMaturityDetailForm" property="prid"/>');return false">
