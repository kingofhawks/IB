	...
	<tr>
		...
		<table width="100%" height="100%" border="0" align="center"
			...
			<tr>
				...
				<div id="innerTable_div"><!--内容开始--> <html:form action="IBDK.do"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<table width="375" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td height="20" align="right" valign="top">接受单据或拒付：</td>
									<td valign="top">
									<div class="sele_div"><html:select property="drrv">
										<%out.println(request.getAttribute("OPTION_DRRV"));%>
									</html:select></div>
									</td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">通知日期：</td>
									<td valign="top"><html:text styleClass="date" property="ardt"
										readonly="true" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td valign="top"><html:text styleClass="bank" property="ngbk"
										readonly="true" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td valign="top"><html:textarea property="ngbkad"
										readonly="true"></html:textarea></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top">议付行的业务编号：</td>
									<td valign="top"><html:text property="ngno" readonly="true" /></td>
								</tr>
								<tr>
      ...
      if(draftFlag){%>
		...
		onClick="openReplace('/IB/voucher.do?prid=<bean:write name="discrepancyIdentlfiedRefuseOrAcceptDetailForm" property="prid"/>&step=<%=step%>&flag=flag&rfno=<bean:write name="discrepancyIdentlfiedRefuseOrAcceptDetailForm" property="rfno"/>&no=<bean:write name="discrepancyIdentlfiedRefuseOrAcceptDetailForm" property="ibno"/>');return false">&nbsp;&nbsp;
		
		<%if(tabID!=null&&tabID.equals("6")){//流程图，只能在以生效里面看到%>
		<input	type="image" src='<bean:message key="common.svg" />'
		onClick="window.open('/IB/flowchart.do?id=<bean:write name="discrepancyIdentlfiedRefuseOrAcceptDetailForm" property="ibno"/>&prid=<bean:write name="discrepancyIdentlfiedRefuseOrAcceptDetailForm" property="prid"/>','newwindow','toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no');return false">&nbsp;&nbsp;
		<%}
          }
		...
		onClick="openReplace('importBillManageAction.do?tabID=<%=tabID%>&prid=<bean:write name="discrepancyIdentlfiedRefuseOrAcceptDetailForm" property="prid"/>');return false">
