...
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
                ...
                <tr>
                    ...
                    <td align="center" class="innerTable_main">
                        <div id="innerTable_div">
                            ...
                            <!--内容开始-->
                            <html:form action="IBRB.do" onsubmit="checkForm(this)" method="post">
                                ...
                                <tr>
                                    <td width="50%" valign="top">                                        
                                        <table width="375" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">放单：</td>
                                                <td valign="top">
                                           
                                                    <div class="sele_div"><html:select
                                        property="rbfg">
                                        <%out.println(request.getAttribute("OPTION_RBFG"));%>
                                    </html:select>
                                    <div>
                                                </td>
                                            </tr>
      ...
      if(draftFlag){%>
		...
		onClick="openReplace('/IB/voucher.do?prid=<bean:write name="importBillDischargeBillDetailForm" property="prid"/>&step=<%=step%>&flag=flag&rfno=<bean:write name="importBillDischargeBillDetailForm" property="rfno"/>&no=<bean:write name="importBillDischargeBillDetailForm" property="ibno"/>');return false">&nbsp;&nbsp;
		
		<%if(tabID!=null&&tabID.equals("6")){//流程图，只能在以生效里面看到%>
		<input	type="image" src='<bean:message key="common.svg" />'
		onClick="window.open('/IB/flowchart.do?id=<bean:write name="importBillDischargeBillDetailForm" property="ibno"/>&prid=<bean:write name="importBillDischargeBillDetailForm" property="prid"/>','newwindow','toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no');return false">&nbsp;&nbsp;
		<%}
          }
		...
		onClick="openReplace('importBillManageAction.do?tabID=<%=tabID%>&prid=<bean:write name="importBillDischargeBillDetailForm" property="prid"/>');return false">
