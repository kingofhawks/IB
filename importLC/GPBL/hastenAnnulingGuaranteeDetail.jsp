...
<table width="100%" height="100%" border="0" align="center"
	...
	<tr>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<table width="375" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td width="40%" height="20" align="right" valign="top">申请人：</td>
      ...
      if(draftFlag){%>
		...
		onClick="window.open('/IB/flowchart.do?id=<bean:write name="hastenAnnulingGuaranteeDetailForm" property="sgno"/>&prid=<bean:write name="hastenAnnulingGuaranteeDetailForm" property="prid"/>','newwindow','toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no')">&nbsp;&nbsp;
		<%}
		...
		onClick="openReplace('gpblManageAction.do?tabID=<%=tabID%>&prid=<bean:write name="hastenAnnulingGuaranteeDetailForm" property="prid"/>');return false">
