...
<html:form action="gpblManageAction.do">
		...
		<table width="100%" height="100%" border="0" align="center"
			...
			<tr>
				...
				<div id="innerTable_divLis" style="width:96%"><!-内容开始--><%String cost = com.witsoft.common.Constant.isHaveReceiveDraft(prid,(String)request.getAttribute("tabID"));%><script>showDone("<%if(request.getAttribute("msg")!=null){out.print(request.getAttribute("msg"));}%>");</script> <logic:equal
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						id="item_list">
						<tr>
							<th width="30%"><bean:message key="common.sgno" /><!--提货担保号--></th>
							<th width="25%"><bean:message key="common.lcno" /><!--信用证号--></th>
							...
							<logic:iterate id="list" name="list" indexId="index" scope="request">
								<span
									<%=cost%>="openReplace('<%=prid%>.do?rfno=<bean:write
                                        name="list" property="id.sgno"/>&prid=<%=prid%>')">
            ...
            out.print("<tr bgcolor=\"#ECF4FC\" onmouseover=\"this.style.backgroundColor=\'#FFCC99\';\" onmouseout=\"this.style.backgroundColor=\'#ECF4FC\';\">");
             ...
             out.print("<tr bgcolor=\"#ffffff\" onmouseover=\"this.style.backgroundColor=\'#FFCC99\';\" onmouseout=\"this.style.backgroundColor=\'#ffffff\';\">");
									...
									<td><bean:write name="list" property="id.sgno" /></td>
									<td><bean:write name="list" property="lcno" /></td>
									<td><bean:write name="list" property="apno" /></td>
...
<logic:notEqual name="userCommonForm"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						id="item_list">
						<tr>
							<th width="24%"><bean:message key="common.sgno" /><!--提货担保号--></th>
							<th width="27%"><bean:message key="common.rfno" /><!--交易流水--></th>
							<th width="24%"><bean:message key="common.lcno" /><!--信用证编号--></th>
							<th width="24%"><bean:message key="common.clno" /><!--客户号--></th>
						</tr>
						<logic:notEmpty name="list">
							<logic:iterate id="list" name="list" indexId="index" scope="request">
								<span
            ...
            out.print("<tr bgcolor=\"#ECF4FC\" onmouseover=\"this.style.backgroundColor=\'#FFCC99\';\" onmouseout=\"this.style.backgroundColor=\'#ECF4FC\';\">");
             ...
             out.print("<tr bgcolor=\"#ffffff\" onmouseover=\"this.style.backgroundColor=\'#FFCC99\';\" onmouseout=\"this.style.backgroundColor=\'#ffffff\';\">");
									...
									<td><bean:write name="list" property="sgno" /></td>
				...
				<logic:equal name="userCommonForm"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						id="item_list">
						<tr>
							<th width="10%"><bean:message key="common.mgtp" /></th>
							<th width="15%"><bean:message key="common.sentBrno" /></th>
							<th width="10%"><bean:message key="common.prid" /></th>
							<th width="20%">业务编号</th>
							<th width="45%"><bean:message key="common.sentTime" /></th>
						</tr>
						<logic:notEmpty name="list">
							<logic:iterate id="list" name="list" indexId="index" scope="request">
								<%if ((index.intValue() % 2) == 1) {
