                                    ...
                                    <td width="50%" valign="top">                                        
                                        <table width="375" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top"><textarea name="APNT" ><%if(map.get("APNT") != null){out.print(map.get("APNT"));}%></textarea></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">AD NO：</td>
                                                <td valign="top"><input type="text" name="ADNO" maxlength="16" value="<%if(map.get("ADNO") != null){out.print(map.get("ADNO"));}%>"></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">Issuing Bank：</td>
                                                <td valign="top"><input type="text" name="ISBKNM" maxlength="35" value="<%if(map.get("ISBKNM") != null){out.print(map.get("ISBKNM"));}%>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">Issuing Bank Name and Address： </td>
                                                <td valign="middle"><textarea name="IBNA" ><%if(map.get("IBNA") != null){out.print(map.get("IBNA"));}%></textarea></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">Transfer Bank：</td>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top"><input type="text" name="COME" value="<%if(map.get("COME") != null){out.print(map.get("COME"));}%>">
                                                <input type="image" name="more_btn" src="/IB/images/date.gif" tabindex="1" onClick="openWin('date','COME');return false">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">到期地点：</td>
                                                <td valign="top">
                                                    <input type="text" name="TONE" value="<%if(map.get("TONE") != null){out.print(map.get("TONE"));}%>">
												</td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">最迟装船日期：</td>
                                                <td valign="top"><input type="text" name="ZHIS" value="<%if(map.get("ZHIS") != null){out.print(map.get("ZHIS"));}%>">
                                                <input name="more_btn" type="image" tabindex="1" onClick="openWin('date','ZHIS');return false"  src="/IB/images/date.gif">
                                                </td>
                                            </tr>
                                            <tr>
