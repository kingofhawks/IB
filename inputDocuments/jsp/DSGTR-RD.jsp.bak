                                    ...
                                    <td width="50%" valign="top">                                        
                                        <table width="375" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td valign="top"><input type="text" name="SGNO" maxlength="15" value="<%if(map.get("SGNO") != null){out.print(map.get("SGNO"));}%>"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">Client No.： </td>
                                                <td valign="top"><input type="text" name="CLNO" maxlength="15" value="<%if(map.get("CLNO") != null){out.print(map.get("CLNO"));}%>"></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">Client Name： </td>
                                                <td valign="top"><input type="text" name="CLNAME" maxlength="60" value="<%if(map.get("CLNAME") != null){out.print(map.get("CLNAME"));}%>"></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">LC No.： </td>
                                                <td valign="top"><input type="text" name="LCNO" maxlength="16" value="<%if(map.get("LCNO") != null){out.print(map.get("LCNO"));}%>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">SG Currenty： </td>
                                                <td valign="top"><div class="sele_div">
                     							<select styleClass="coin" name="GUCY">
                                                <%out.println(ConvertOptions.ConvertCurrencyArrayToString((String [][])request.getAttribute("OPTION_CYNO"), (String)map.get("GUCY")));%>
                                                </select>
									</div>
												</td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">SG Amount： </td>
                                                <td valign="top"><input type="text" name="GUAM" value="<%if(map.get("GUAM") != null){out.print(map.get("GUAM"));}%>"></td>
                                            </tr>
                                        </table>
                                    </td>
