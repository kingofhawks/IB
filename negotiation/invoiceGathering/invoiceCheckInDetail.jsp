	...
	<tr>
		...
		<table width="100%" height="100%" border="0" align="center"
			...
			<tr>
				...
				<div id="innerTable_div" class="kuangScroll"><!--内容开始--> <html:form action="EBRG.do"
						...
						<tr>
							...
							<table width="375" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td valign="top"><html:text property="bpno" title="bpno" readonly="true" /></td>
								</tr>
								<tr>
									<td height="20" align="right" valign="top" class="attR">来证通知号：</td>
									<td valign="top"><html:text property="adno" title="adno" readonly="true" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td valign="top"><html:text title="lcno" property="lcno" readonly="true" maxlength="16"/></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<div class="sele_div"><html:select property="ckgt" onchange="switchlgfg()">
								...
								<tr>
									...
									<td valign="top"><html:text title="dlam" property="dlam" onblur="checkDlam()" onkeypress="regInput(/^\d{1,}\.?\d{0,2}$/)" style="ime-mode:Disabled" maxlength="15" onchange="getCharge('caam',$('dlcy').value,$('dlam').value,$('prid').value)"/></td>
								</tr>
								<tr>
