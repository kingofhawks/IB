	...
	<tr>
		...
		<table width="100%" height="100%" border="0" align="center"
			...
			<tr>
				...
				<div id="innerTable_divLis" style="width:96%"><!-内容开始--><%String cost = com.witsoft.common.Constant.isHaveReceiveDraft(prid,(String)request.getAttribute("tabID"));%><script>showDone("<%if(request.getAttribute("msg")!=null){out.print(request.getAttribute("msg"));}%>");</script>
				<logic:equal
					name="userCommonForm" property="tabID" value="1">
					<table width="100%"  border="0" cellpadding="0"
						cellspacing="1" id="item_list">
						<tr>
						<th width="26%"><bean:message key="common.bpno" /><!--议付编号--></th>
...
<logic:notEqual name="userCommonForm"
					...
					<table width="100%"  border="0" cellpadding="0"
						cellspacing="1" id="item_list">
						<tr>
						<th width="20%"><bean:message key="common.bpno" /><!--议付编号--></th>
						<th width="22%"><bean:message key="common.rfno" /><!--流水号--></th>
						<th width="18%"><bean:message key="common.clno" /><!--客户号--></th>
						<th width="20%">银行编号<!--机构号--></th>
						<th width="20%"><bean:message key="common.dldt" /><!--处理日期--></th>
						</tr>
						<logic:notEmpty name="list">
							<logic:iterate id="list" name="list" indexId="index" scope="request">
									<span
				...
				<logic:equal name="userCommonForm"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						...
						<tr>
							...
							<th width="19%"><bean:message key="common.sentBrno" /></th>
							<th width="22%"><bean:message key="common.prid" /></th>
							<th width="21%">业务编号</th>
							<th width="20%"><bean:message key="common.sentTime" /></th>
						</tr>
						<logic:notEmpty name="list">
							<logic:iterate id="list" name="list" indexId="index" scope="request">
								<%if ((index.intValue() % 2) == 1) {
