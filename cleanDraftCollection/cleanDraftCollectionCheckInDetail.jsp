...
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
                ...
                <tr>
                    ...
                    <td align="center" class="innerTable_main">
                        <div id="innerTable_div">
                            ...
                            <!--内容开始-->
                            <html:form action="CCRG.do" onsubmit="checkForm(this)" method="post">
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                        ...
                                        <table width="375" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top">
                                                    ...
                                                    <html:image src="/IB/images/winsearch.gif" tabindex="1" property="more_btn" onclick="openWin('clientNum','clno,clnonm,clnoad');return false"></html:image></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">收款人名称：</td>
                                                <td valign="top">
                                                    <html:text property="clnonm" readonly="true"/>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*票据类型：</td>
                                                <td valign="top">
                                                   <div class="sele_div"><html:select property="bltp" title="bltp">
                                        <%out.println(request.getAttribute("OPTION_BITP"));%>
                                        </html:select></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*票据张数：</td>
                                                <td valign="top"><html:text title="blcn" property="blcn" maxlength="8"/></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top">票据号码：</td>
                                                <td valign="top"><html:text property="blno" maxlength="16"/></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*票据币种：</td>
                                                <td valign="top">
                                                    <div class="sele_div"><html:select styleClass="coin" property="cyno" title="cyno" onchange="getCharge('caam',$('cyno').value,$('amts').value,$('prid').value)">
									...
									<html:option value="<%=cyno[0]%>"><%=cyno[1]%></html:option>	
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*票据金额：</td>
                                                <td valign="top"><html:text title="amts" property="amts" maxlength="15" onchange="getCharge('caam',$('cyno').value,$('amts').value,$('prid').value)"/></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*托收方式：</td>
                                                <td valign="top">
                                                  
                                                    <div class="sele_div"><html:select
                                        property="ccmd" title="ccmd">
                                        <%out.println(request.getAttribute("OPTION_CCMD"));%>
                                    </html:select></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*代收行：</td>
                                                <td valign="top"><html:text title="icbk" property="icbk"/>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top"><html:text property="pre1"/></td>
                                            </tr>
                                            <tr>
                                                <td height="20" align="right" valign="top" class="attR">*付款人国别及地区：</td>
                                                <td valign="top">
									...
									<html:option value="<%=list.getSwcd()%>"><bean:write name="list" property="ctnm"/></html:option>	
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">地区：</td>
                                                <td valign="top"><html:text property="cncd2" maxlength="16"/></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <td width="50%" valign="top">
                                        <table width="375" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td width="40%" height="20" align="right" valign="top">核销单号码：</td>
                                                <td valign="top"><html:text property="dtno" maxlength="16"/>
                                                </td>
                                            </tr>
                                            <tr>
										...
										<option value="01">CNY 人民币</option>
                                            ...
                                            <tr>
                                                <td height="20" align="right" valign="top">实收邮电费类型：</td>
                                                <td valign="top">
		...
		<input type="image" src='<bean:message key="common.svg" />' onClick="window.open('/IB/flowchart.do?id=<bean:write name='cleanDraftCollectionCheckInDetailForm' property='ccno'/>&prid=<bean:write name='cleanDraftCollectionCheckInDetailForm' property='prid'/>','newwindow','toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no');return false">
		&nbsp;&nbsp;
        <%}%>
		<input type="image" src='<bean:message key="common.returnList" />' onClick="openReplace('cleanDraftCollectionManageAction.do?tabID=<%=tabID%>&prid=<bean:write name='cleanDraftCollectionCheckInDetailForm' property='prid'/>');return false">
		<%
