...
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
                ...
                <tr>
                    ...
                    <td align="center" class="innerTable_main">
                        <div id="innerTable_div">
                            ...
                            <!--内容开始-->
                            <html:form action="CCCL.do" onsubmit="checkForm(this)" method="post">
                                    ...
                                    <td width="50%" valign="top">                                        
                                        <table width="375" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td valign="top"><html:text property="ccno" readonly="true" title="ccno"/></td>
                                            </tr>
                                        </table>
                                    </td>
       ...
       <%}%>
		...
		<input type="image" src='<bean:message key="common.svg" />' onClick="window.open('/IB/flowchart.do?id=<bean:write name='cleanDraftAnnulDossierDetailForm' property='ccno'/>&prid=<bean:write name='cleanDraftAnnulDossierDetailForm' property='prid'/>','newwindow','toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no');return false">
		&nbsp;&nbsp;
        <%}%>
        <input type="image" src='<bean:message key="common.returnList" />' onClick="openReplace('cleanDraftCollectionManageAction.do?tabID=<%=tabID%>&prid=<bean:write name='cleanDraftAnnulDossierDetailForm' property='prid'/>');return false">
    	<%
