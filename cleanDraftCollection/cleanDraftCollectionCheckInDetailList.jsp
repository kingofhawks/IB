...
<table width="100%" height="100%" border="0" align="center"
	...
	<tr>
		...
		{%>
		<script	language="javascript">showOperation_new("<%=prid%>.do?prid=<%=prid%>");</script>
		<%}%>
		</td>
			...
			<tr>
				...
				<div id="innerTable_divLis" style="width:96%"><!-内容开始--><script>showDone("<%if(request.getAttribute("msg")!=null){out.print(request.getAttribute("msg"));}%>");</script> 
					...
					<table width="100%"  border="0" cellpadding="0"
						...
						<tr>
							<th width="26%"><bean:message key="common.ccno" /><!--托收编号--></th>
							<th width="24%"><bean:message key="common.rfno" /><!--交易流水--></th>
							<th width="15%"><bean:message key="common.clno" /><!--客户号--></th>
