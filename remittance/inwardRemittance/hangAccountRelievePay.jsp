	...
	<tr>
		...
		<table width="100%" height="100%" border="0" align="center"
			...
			<tr>
				...
				<div id="innerTable_div"  class="kuangScroll"><!--录入信息表格开始--> <html:form action="IRPB.do"
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<table width="375" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td align="right" valign="top">汇款号码：</td>
									<td align="left" valign="middle"><html:text maxlength="16"
										property="dfno" /></td>
								</tr>
								<tr>
									<td align="right" valign="top">汇款行业务编号：</td>
									<td align="left" valign="middle"><html:text readonly="true"
										maxlength="16" property="orno" /></td>
								</tr>
								<tr>
									<td align="right" valign="top">汇款行国别：</td>
									<td align="left" valign="middle">
									<div class="sele_div"><html:select styleClass="coin"
								...
								<tr>
									<td align="right" valign="top" class="font_red">*对公/对私：</td>
									<td align="left" valign="middle">
									<div class="sele_div_122"><html:select styleClass="select_122"
							...
							<table width="375" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td align="right" valign="top" class="font_red">*收款人代码：</td>
								...
								<tr>
									<td width="131" align="right" valign="top" class="font_red">*解付方式：</td>
								...
								<tr>
									<td align="right" valign="top">收款人帐号：</td>
									<td align="left" valign="middle">
								...
								<tr>
									<td align="right" valign="top">解付金额：</td>
								...
								<tr>
									<td align="right" valign="top">转他行机构号：</td>
