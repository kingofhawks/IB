			...
			<tr>
				...
				<logic:equal name="userCommonForm" property="tabID" value="1">
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						id="item_list">
						<tr>
							<th width="35%"><bean:message key="common.irno" /><!--汇入汇款编号--></th>
							<th width="30%"><bean:message key="common.orno" /><!--汇出汇款编号--></th>
							...
							<logic:iterate id="list" name="list" indexId="index" scope="request">
								<span
									<%=cost%>="openReplace('<%=prid%>.do?rfno=<bean:write
                                        name="list" property="id.irno"/>&prid=<%=prid%>')">
								
									<td><bean:write name="list" property="id.irno" /></td>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					id="item_list">
					<tr>
						<th width="30%"><bean:message key="common.irno" /></th>
