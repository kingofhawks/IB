...
%>
<html:form action="outwardManageAction.do">
...
<%--		{%>--%>
<%--		<script language="javascript">showOperation_new("/IB/report1.do?prid=<%=prid%>&flag=flag");</script>--%>
<%--		<%}%>--%>
		...
		<table width="100%" height="100%" border="0" align="center"
			...
			<tr>
				...
				<div id="innerTable_divLis" style="width:96%"><!-内容开始-->
				 <%String cost = com.witsoft.common.Constant.isHaveReceiveDraft(prid,(String)request.getAttribute("tabID"));%>
				<!-内容开始--><script>showDone("<%if(request.getAttribute("msg")!=null){out.print(request.getAttribute("msg"));}%>");</script>
				<logic:equal name="userCommonForm" property="tabID" value="1">
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						id="item_list">
						<tr>
						    <th width="60%"><bean:message key="common.orno" /><!--汇出汇款编号--></th>
							<th width="40%">银行编号<!--机构号--></th>
						</tr>
						<logic:notEmpty name="list">
							<logic:iterate id="list" name="list" indexId="index" scope="request">
								<span
									<%=cost%>="openReplace('<%=prid%>.do?rfno=<bean:write
                                        name="list" property="id.orno"/>&prid=<%=prid%>')">
            ...
            out.print("<tr bgcolor=\"#ECF4FC\" onmouseover=\"this.style.backgroundColor=\'#FFCC99\';\" onmouseout=\"this.style.backgroundColor=\'#ECF4FC\';\">");
             ...
             out.print("<tr bgcolor=\"#ffffff\" onmouseover=\"this.style.backgroundColor=\'#FFCC99\';\" onmouseout=\"this.style.backgroundColor=\'#ffffff\';\">");
									...
									<td><bean:write name="list" property="id.orno" /></td>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					id="item_list">
					<tr>
						<th width="30%"><bean:message key="common.orno" /></th>
						<th width="25%"><bean:message key="common.rfno" /></th>
						<th width="20%">银行编号</th>
						<th width="25%"><bean:message key="common.dldt" /></th>
					</tr>
					<logic:notEmpty name="list">
						<logic:iterate id="list" name="list" indexId="index" scope="request">
							<%if ((index.intValue() % 2) == 1) {
